 ...
 */
public class FibonacciHeapComp {
     ...
     */
    public static FibonacciHeapComp union(FibonacciHeapComp H1, FibonacciHeapComp H2) {
        FibonacciHeapComp H = new FibonacciHeapComp();
        if (H1 != null && H2 != null) {
            H.min = H1.min;
            if (H.min != null) {
                if (H2.min != null) {
