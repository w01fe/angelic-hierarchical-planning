(ns angelic.old.angelic.hybrid.hierarchies.strips
  (:use angelic.old.angelic 
        angelic.old.angelic.hierarchies
        angelic.old.angelic.hybrid )
  (:require [angelic.util :as util] [angelic.old  [envs :as envs]]
        [angelic.util [propositions :as props] [hybrid :as hybrid] 
	...
	[angelic.old.envs.hybrid-strips [constraints :as hc] [effects :as he]]
        [angelic.old.angelic.hybrid.ncstrips-descriptions :as hybrid-ncstrips]
        [angelic.old.angelic.hybrid.dnf-lp-valuations :as hdlv]
        )
  )
...
(derive ::HybridStripsHLA               :angelic.old.angelic.hierarchies/HLA)
...
(defmethod hla-immediate-refinements [::HybridStripsPrimitiveHLA :angelic.old.angelic/Valuation] [hla] (throw (UnsupportedOperationException.)))
