(ns angelic.old.angelic.hybrid.ncstrips-descriptions
  (:use angelic.old.angelic angelic.old.angelic.hybrid)
  (:require [angelic.util :as util] 
            [angelic.util [propositions :as props] [hybrid :as hybrid-util]
	    ...
	    [angelic.old.envs.strips.smart-csps :as smart-csps]
            ...
            [angelic.old.angelic.hybrid :as hybrid]
            [angelic.old.angelic.hybrid [dnf-lp-valuations :as hdlv] [continuous-lp-states :as cls]]
            ))
...
(derive ::HybridNCStripsDescription :angelic.old.angelic/PropositionalDescription)
