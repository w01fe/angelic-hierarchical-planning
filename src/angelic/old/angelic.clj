...
(defmethod restrict-valuation [::Valuation :angelic.old.envs/TrueCondition]
  [val condition]
  val)
...
(defn restrict-clause [clause condition]
  (util/assert-is (isa? (:class condition) :angelic.old.envs/ConjunctiveCondition))
...
(defn make-finish-valuation [rew]
  (map->valuation :angelic.old.angelic.dnf-valuations/DNFSimpleValuation {*finish-state* rew}))
...
(defmethod restrict-valuation [::ExplicitValuation :angelic.old.envs/Condition]
  [val condition]
...
(prefer-method restrict-valuation [::Valuation :angelic.old.envs/TrueCondition] [::ExplicitValuation :angelic.old.envs/Condition])
...
(defmethod restrict-valuation [::ConditionalValuation :angelic.old.envs/Condition] 
  [val cond]
  (make-conditional-valuation 
   (envs/conjoin-conditions (:condition val) cond) 
   (:max-reward val)))

(prefer-method restrict-valuation [::Valuation :angelic.old.envs/TrueCondition] [::ConditionalValuation :angelic.old.envs/Condition])
...
(defmethod restrict-valuation [::UnionValuation :angelic.old.envs/Condition] restrict-valuation-union [v c]
...
(prefer-method restrict-valuation [::Valuation :angelic.old.envs/TrueCondition] [::UnionValuation :angelic.old.envs/Condition])
