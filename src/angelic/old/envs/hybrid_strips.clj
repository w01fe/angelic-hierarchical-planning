(ns angelic.old.envs.hybrid-strips
 (:use     angelic.util.hybrid)
...
(derive ::HybridStateSpace ::angelic.old.envs/StateSpace)
...
(defmethod angelic.old.envs/list-states ::HybridStateSpace [state-set]
  (throw (UnsupportedOperationException.)))

(defmethod angelic.old.envs/canonicalize ::HybridStateSpace [state-set]
  state-set)  

(defmethod angelic.old.envs/set-contains? ::HybridStateSpace [state-set elt]
