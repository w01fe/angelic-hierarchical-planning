...
(defrecord OutputSetNode
  [subproblem output-set
   parent-node ancestor-summary-atom   ; Plans directly at ancestors
   plans-atom plans-summary-atom       ; Plans directly at node
   children-atom children-summary-atom ; Plans at descendents
   ])

(defn make-initial-output-set-pointer [subproblem ])
